...
## Mục tiêu
- Hiểu rõ cách hoạt động của mô hình Linear Regression.
...
4.	Xây dựng mô hình Linear Regression sử dụng scikit-learn.
...
## Kết quả
Mô hình Linear Regression đã được huấn luyện thành công và cho kết quả khả quan trên tập dữ liệu kiểm thử, thể hiện qua chỉ số R² và trực quan hóa dữ liệu phù hợp.
